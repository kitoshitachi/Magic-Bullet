...
class MovingImages:
    ...
    def __post_init__(self):
      self._move_sequences = [self.down_right_move, self.down_move, self.down_left_move, self.left_move, self.up_left_move, self.up_move, self.up_right_move, self.right_move]
      self._idle_sequences = [self.down_right_idle, self.down_idle, self.down_left_idle,self.left_idle, self.up_left_idle, self.up_idle, self.up_right_idle, self.right_idle]
